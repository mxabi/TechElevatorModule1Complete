...
class MainProgram {
    ...
    private static void demoCards(){
      ...
      List<Card> trevorsHand = new ArrayList<>();
      List<Card> evanHand = new ArrayList<>();
      List<Card> deseraeHand = new ArrayList<>();

      for (int i=0; i<5; i++) { //deal everyone 5 cards
          trevorsHand.add(deck.dealOne());
          evanHand.add(deck.dealOne());
          deseraeHand.add(deck.dealOne());
      }
      System.out.println("Trevors Hand:"+trevorsHand);
      System.out.println("Evans Hand:"+evanHand);
      System.out.println("Deserae Hand:"+deseraeHand);
