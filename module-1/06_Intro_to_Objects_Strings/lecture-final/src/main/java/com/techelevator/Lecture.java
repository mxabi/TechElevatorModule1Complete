...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		System.out.println("Should be true: 0123457789, s2=0123456789 return is "+ doStringMiddlesMatch("0123457789", "0123456789",true));
		System.out.println("Should be true: 0123456789, s2=9993456789 return is "+ doStringMiddlesMatch("0123456789", "9993456789",true));
		System.out.println("Shouuld be false: 0123456789, s2=0124456789 return is "+ doStringMiddlesMatch("0123456789", "0124456789",true));
		System.out.println("Should be false: 012aaa6789, s2=999AAA6789 caseSens is true return is "+ doStringMiddlesMatch("012aaa6789", "999AAA6789",true));
		System.out.println("Should be true: 012aaa6789, s2=999AAA6789 caseSens is false return is return is "+ doStringMiddlesMatch("012aaa6789", "999AAA6789",false));
	}
	...
	public static boolean doStringMiddlesMatch (String s1, String s2, boolean caseSensitive){
		...
		if (caseSensitive){
			return s1.charAt(3)==s2.charAt(3) && s1.charAt(4)==s2.charAt(4) && s1.charAt(5)==s2.charAt(5);
		} else {
			return s1Sub.equalsIgnoreCase(s2Sub);
		}
	}
}
