...
public class Examples {
	...
	public static void main(String[] args) {
		...
		//naming rules - camelCase the first character is lowercase and every subsequent word starts with uppercase
		//nameOfTheVariable, numberOfStudents, minutesTillNextBreak,
		// sPonGEbOBCAse - not camel case
		int sPonGEbOBCAse; //this is breaking guidelines not required rules so allowed but bad
		/*cant name a keyword
		int int;
		int public;
		*/
		...
		//explicit conversion - i'm ok with losing data
		myByte = (byte) myInt;
